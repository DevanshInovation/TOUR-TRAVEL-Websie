  ...
  const recommendationsData = [
   {
      ...
      // 🔱 12 Jyotirlingas (Spiritual)
    {
      image: Somnath,
      title: "Somnath",
      subTitle: "Somnath, Gujarat — the first among the 12 Jyotirlingas of Lord Shiva.",
      cost: "13,500",
      duration: "Approx 3 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      image: Mallikarjuna,
      title: "Mallikarjuna",
      subTitle: "Mallikarjuna, Srisailam — a major Jyotirlinga on the Krishna River.",
      cost: "15,200",
      duration: "Approx 3 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      image: Mahakaleshwar,
      title: "Mahakaleshwar",
      subTitle: "Mahakaleshwar, Ujjain — famous temple of Lord Shiva, Jyotirlinga in Madhya Pradesh.",
      cost: "10,600",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      image: Omkareshwar,
      title: "Omkareshwar",
      subTitle: "Omkareshwar, on Narmada River island, one of the 12 Jyotirlingas.",
      cost: "9,800",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      image: Kedarnath,
      title: "Kedarnath",
      subTitle: "Kedarnath, Uttarakhand — high-altitude temple dedicated to Lord Shiva.",
      cost: "14,900",
      duration: "Approx 3 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      image: Bhimashankar,
      title: "Bhimashankar",
      subTitle: "Bhimashankar, Maharashtra — temple in Sahyadri hills, Jyotirlinga of Lord Shiva.",
      cost: "8,700",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      ...
      subTitle: "Kashi Vishwanath, Varanasi — one of the holiest Shiva temples in India.",
      cost: "9,000",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      image: Trimbakeshwar,
      title: "Trimbakeshwar",
      subTitle: "Trimbakeshwar, Nashik — sacred Jyotirlinga located near Godavari River.",
      cost: "8,400",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      image: Baidyanath,
      title: "Baidyanath",
      subTitle: "Baidyanath, Deoghar — known as Baba Dham, one of the 12 Jyotirlingas.",
      cost: "10,200",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      image: Nageshwar,
      title: "Nageshwar",
      subTitle: "Nageshwar, near Dwarka — one of the oldest Jyotirlinga shrines.",
      cost: "11,500",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      ...
      subTitle: "Rameshwaram — sacred Jyotirlinga located in Tamil Nadu, linked to Ramayana.",
      cost: "16,800",
      duration: "Approx 4 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      image: Grishneshwar,
      title: "Grishneshwar",
      subTitle: "Grishneshwar, near Ellora — last among the 12 Jyotirlingas of Shiva.",
      cost: "8,900",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
...

    {
      ...
      subTitle: "Kamakhya Temple, Assam — one of the most revered Shakti Peethas of Goddess Shakti.",
      cost: "14,600",
      duration: "Approx 3 night trip",
      type: "Spiritual",
      category: "Spiritual",
    ...
    },
    {
      image: Vaishno,
      title: "Vaishno Devi",
      subTitle: "Vaishno Devi, Jammu — major pilgrimage in Trikuta Hills dedicated to Goddess Durga.",
      cost: "13,200",
      duration: "Approx 3 night trip",
      type: "Spiritual",
      category: "Spiritual",
    ...
    },
    {
      ...
      subTitle: "Kalighat, Kolkata — one of the 51 Shakti Peethas of Goddess Kali.",
      cost: "10,800",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      image: Hinglaj,
      title: "Hinglaj Mata",
      subTitle: "Hinglaj Mata, Balochistan — ancient Shakti Peeth located in Hingol National Park.",
      cost: "21,000",
      duration: "Approx 4 night trip",
      type: "International",   // International for Hinglaj Mata!
      category: "Spiritual",
    },
    {
      image: Vindhyavasini,
    ...
    },
    {
      ...
      subTitle: "Madurai — architectural marvel and major Shakti Peeth of Goddess Parvati.",
      cost: "14,500",
      duration: "Approx 3 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      ...
      subTitle: "Mysuru, Karnataka — temple dedicated to Goddess Durga atop Chamundi Hills.",
      cost: "11,400",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      ...
      subTitle: "Ratnagiri, Maharashtra — one of the ancient Shakti Peeths on western coast.",
      cost: "8,900",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      image: Sharada,
      title: "Sharada Peeth",
      subTitle: "Sharada Peeth, Kashmir — ancient learning center and Shakti temple.",
      cost: "15,700",
      duration: "Approx 3 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      ...
      subTitle: "Srisailam, Andhra Pradesh — Shakti Peeth paired with Mallikarjuna Jyotirlinga.",
      cost: "14,200",
      duration: "Approx 3 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      ...
      subTitle: "Kolhapur — one of the sacred Shakti Peeths of Goddess Lakshmi.",
      cost: "9,600",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
    ...
    },
    {
      ...
      subTitle: "Haridwar, Uttarakhand — one of the most visited Shakti Peeth temples.",
      cost: "10,200",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
    },
    {
      ...
      subTitle: "Odisha — dedicated to Goddess Bhuvaneshwari, part of 18 Maha Peeths.",
      cost: "11,000",
      duration: "Approx 2 night trip",
      type: "Spiritual",
      category: "Spiritual",
